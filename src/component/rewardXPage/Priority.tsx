...
const Priority = () => {
  return (
    <section className="w-full bg-gradient-to-br bg-white border border-white text-black px-6 py-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        {/* Right Image Card */}
        <div className="bg-white rounded-xl shadow-lg px-8 py-6 flex items-center gap-8 w-[200px] md:w-[260px] justify-center font-poppins">
