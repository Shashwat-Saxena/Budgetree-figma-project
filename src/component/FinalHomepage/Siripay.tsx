...
import siripay from '@/Image/Component 12.svg'
const Siripay = () => {
  return (
    <>
  ...
  <div className="w-1/2  ml-[33]">
    ...
    <button type="button" className='bg-gradient-to-r from-blue-600 to-blue-400 text-white px-6 py-3 rounded-full text-sm hover:opacity-90 transition'>Explore</button>
  </div>
  <div className="w-1/2 ">
  <Image src={siripay} alt='Image' className='w-full h-auto rounded-lg' />
    {/* <img src={siripay} alt="Image" className="w-full h-auto rounded-lg" /> */}
  </div>
</div>
    </>
  )
